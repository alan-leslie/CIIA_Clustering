...
public class MSTSingleLinkAlgorithm {
    ...
    public MSTSingleLinkAlgorithm(MultiDimensionalDataPoint[] elements, double[][] adjacencyMatrix) {
    ...
    private double mergeTwoClosestClusters() {
        ...
        double d = Double.NaN;
        if( minI > -1 ) {
            MultiDimensionalDataPoint e1 = elements[minI];
            Cluster c1 = allClusters.findClusterByElement(e1);
            MultiDimensionalDataPoint e2 = elements[minJ];
